package com.zp.libvideoedit.GPUImage.Carma;
...
//		Camera.Size previewSize = getDefaultPreviewSize();
...
//	private Camera.Size getDefaultPreviewSize() {
//
//        List<Camera.Size> supportedPreviewSizes =
//				mCamera.getParameters().getSupportedPreviewSizes();
//        Camera.Size previewSize = null;
//        int width = DensityUtil.getDisplayWidth(mContext);
//        int height = DensityUtil.getDisplayHeight(mContext);
...
//                }
//            }
//            if (previewSize != null && previewSize.height > 720) {
//                for (int i = 0; i < supportedPreviewSizes.size(); i++) {
//                    Camera.Size size = supportedPreviewSizes.get(i);
//                    if (size.height <= 720) {
//                        previewSize = size;
