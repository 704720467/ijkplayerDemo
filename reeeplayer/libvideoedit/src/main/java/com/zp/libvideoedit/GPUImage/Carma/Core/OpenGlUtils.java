...
public class OpenGlUtils {
	...
	public static int getTexutre2DId(int width, int height,int[] textureId, int type)
	{
	...
	public static Bitmap drawToBitmapByFilter(Bitmap bitmap, GPUImageFilter filter,
		...
		filter.setInputSize(new GPUSize(displayWidth,displayHeight),0);
        ...
        filter.newFrameReadyAtTime(0,0,textureId);
