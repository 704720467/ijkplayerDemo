...
import com.zp.libvideoedit.GPUImage.Carma.utils.RenderHandler;
...
public class MediaVideoEncoder extends MediaEncoder {
    ...
    protected void prepare() throws IOException {
        ...
        format.setInteger(MediaFormat.KEY_I_FRAME_INTERVAL, CodecUtils.getEnCodeKeyIFrameInterval());
    ...
    private int calcBitRate() {
        final int bitrate = (int) (FRAME_RATE * mWidth * mHeight * 2.f);
