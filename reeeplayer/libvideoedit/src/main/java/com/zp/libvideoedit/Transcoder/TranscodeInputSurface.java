 ...
 *
 */
class TranscodeInputSurface {
    private static final String TAG = "TranscodeInputSurface";
    ...
    /**
     * Creates an TranscodeInputSurface from a Surface.
     */
    public TranscodeInputSurface(Surface surface) {
        if (surface == null) {
