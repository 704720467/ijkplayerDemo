...
import static com.zp.libvideoedit.utils.CodecUtils.getMimeTypeFor;
...
//            }
            ...
            int totalFrame = (int) (inputFps * durationUs / US_MUTIPLE);
...
//                 格式化音频
    ...
    private MediaCodec createVideoDecoder(MediaFormat inputFormat, Surface surface) throws IOException {
        ...
        videoDecoderHandler.create(false, getMimeTypeFor(inputFormat), videoDecoderCallback);
