...
public class VNIColorFadeTransitionFilter extends GPUImageTransitionFilter {
    public VNIColorFadeTransitionFilter() {
    ...
    public void setFadeColor(float[] fadeColor) {
        ...
        setFloatVec4(fadeColorUniform, fadeColor);
    }

    @Override
    public void setProgress(float progress) {
        this.progress = Math.max(0.1f,progress);
